...
const sendStepOne = () => {
    ...
    $fetch(`/api/backend/projects`, {
        ...
        // ir a /legislador/hubs/proyectos/:id (hub)
        navigateTo(`/legislador/hubs/${response.project.id}?new=true`);
    }).catch(error => {
...
<template>
    <NuxtLayout name="panel-legislador">
        <UPage>
            <UPageHeader title="Nuevo hub de proyecto"
            ...
            <UPageBody>
                ...
                <UPageCard variant="subtle">
                    <UFormField label="Subir PDF del proyecto">
                        ...
                        <UInput type="file" accept=".pdf" class="w-full" @change="onFileChange" />
                    </UFormField>
                    <UFormField label="Nombre del hub del proyecto">
                        ...
                        <UInput v-model="initProjectData.name" class="w-full" label="Nombre del proyecto" placeholder="Escriba aqui" />
                    </UFormField>
                    <UFormField label="Codigo del proyecto">
                        ...
                        <UFieldGroup class="w-full">
                            <UBadge color="neutral" variant="subtle" :label="frontendUrl + '/proyectos/'" />
                    ...
                    <UFormField label="Modo de creación">
                        ...
                        <URadioGroup v-model="creationMode" color="primary" variant="table" default-value="neutral" :items="creationModes" />
                    </UFormField>
                    <UButton @click="sendStepOne" :loading="isLoading" :disabled="isButtonDisabled" icon="lucide:sparkle" variant="solid" class="flex justify-center" color="primary">Crear Hub del Proyecto</UButton>
